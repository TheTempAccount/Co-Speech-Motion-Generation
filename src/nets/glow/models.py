...
from nets.glow import modules
from nets.glow import utils
...
class FlowStep(nn.Module):
    ...
    def normal_flow(self, input, cond, logdet):
        ...
        z, logdet = FlowStep.FlowPermutation[self.flow_permutation](
            self, z, logdet, False)
        # 3. coupling
        z1, z2 = thops.split_feature(z, "split")#f分成了两部分
...
class Glow(nn.Module):
    ...
    def __init__(self, x_channels, cond_channels, hparams):
        ...
        self.z_shape = [hparams.DataLoader.batch_size // num_device, x_channels, 1]
