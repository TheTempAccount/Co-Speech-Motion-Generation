...
class Audio2Pose(nn.Module):
    def __init__(self, num_keypoints, embed_size, augmentation):
        ...
        if self.augmentation:
            self.aud_dec = AudioDecoder(channels=[512, 256, 128, self.num_keypoints*2])
        else:
            self.aud_dec = AudioDecoder(channels=[256, 256, 128, self.num_keypoints*2])
